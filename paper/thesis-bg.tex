...
\[ R(\emph{999+1}) = \]
\[ \verb/"@1 SoT 999 ЕоТ @2 SoT + ЕоТ @1 SoT 1 ЕоТ @3 SoT = EoT"/ \]
...
class Bimachine
{
    public Dfsa Forward { get; set; }
    public Dfsa Reverse { get; set; }
...
\begin{lstlisting}[language=csh,firstnumber=15]
    ...
    {
        var rPath = Bm.Reverse.ReverseRecognitionPath(Input);
