...
Ако \( q = \phi(R) \) е дефинирано, тогава \( \{ q' \in R' \mid \exists w \in \Sigma^* : \langle q, \langle a, m \rangle, q' \rangle \in \Delta \} \neq \emptyset \). От дефиницията на \( \phi'(R') \) следва, че \( \{ w \mid \langle \phi(R), \langle a, m \rangle, \phi'(R') \rangle \in \Delta \} \neq \emptyset \) и \( \psi(\langle L, \phi \rangle, a, R') \) може да се дефинира по посочения начин.
...
Нека разгледаме фигура \ref{fig:FstBm}
