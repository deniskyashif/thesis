...
\begin{example}
	...
	Изхода получаваме като конкатенираме резултатите от функцията на изхода за всяка тройка, състояща се от ляво, дясно състояние и входна буква.
	\begin{equation}
		\begin{split}
		...
		\end{split}
	\end{equation}
	Всяка лексема е обградена от маркери, като преди маркера за начало имаме индекса на правилото в граматиката.
\end{example}
